...
Alpen (Alpine + Pen) is intended to be a super-simple, single-HTML-file replacement for Google Keep. There's lots of other self-hosted notes applications out there (Trilium, Obsidian, LogSeq, Standard Notes, Joplin, etc), which I had tried, but I thought each one was too bloated or complicated for my needs (not that they wouldn't be great for other people, though!). I kept coming back to Google Keep but am dissatisfied with their corporate ethos, so here we are. A simple Google Keep replacement.
...
- Notes!
  ...
  - Editing
  - Deleting
  - Filtering/Searching (planned)
  - Sorting (planned)
  - Tagging (planned)
- Sync
  - WebDAV
- Nothing else! I'm trying to keep this as simple as possible.
